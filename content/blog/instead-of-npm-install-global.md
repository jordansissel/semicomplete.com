...
With my eager eyes set on a goal to make a silly web app. I was reading through the [Ionic+Vue tutorial](https://ionicframework.com/docs/vue/your-first-app). I still have that goal, but I got very delayed by a small side quest. Hello! With ADHD, side quests are my entire life. :)
